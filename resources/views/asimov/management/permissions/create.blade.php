...
@section('content')
	...
	<div class="card">
        <div class="card-header">
            <h2>{{ trans('management/permission.new.title') }}</h2>
        </div>
        <div class="card-body">

            <form action="{{ URL::route('management.permissions.store') }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="fg-line">
                            <input type="text" class="form-control input-sm" id="permission.description" value="{{ Input::old('description') }}"

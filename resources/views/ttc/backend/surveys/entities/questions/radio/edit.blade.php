    ...
    <div class="col-sm-10">
        <div class="fg-line">
            <input type="text" class="form-control input-sm" id="question"
                   ...
                   placeholder="{{ trans('survey/entities/edit.question') }}" name="entity_type[question]">
        </div>
    </div>
</div>
<div class="form-group">
...
@include('ttc.backend.surveys.entities.questions.options_with_skip',['options' => $entity->options])
...
<div class="form-group">
	...
	<div class="col-sm-10">
		<div class="fg-line">
			<textarea class="form-control" id="survey.entities.description"
			          placeholder="{{ trans('survey/entities/edit.description') }}"
			          name="entity_type[description]">{{ Input::old('entity_type.description',$entity->description) }}</textarea>
		</div>
	</div>
</div>
